...
const SchrodingerEquation = () => {
    const questions = [
        {
            text: 'What is the fundamental equation in quantum mechanics that describes how the quantum state of a physical system evolves over time?',
            options: [
            ...
            correctAnswer: 'Schrödinger\'s Equation'
        },
        {
            text: 'What does the time-independent Schrödinger equation find for a quantum system?',
            options: [
                'Time evolution',
                'Energy eigenstates',
            ...
            correctAnswer: 'Energy eigenstates'
        },
        {
            text: 'Which equation describes the evolution of the wavefunction over time?',
            options: [
                'Euler\'s Equation',
                'Maxwell\'s Equations',
                'Schrödinger\'s Equation',
        ...
        {
            text: 'What is the main purpose of Schrödinger\'s equations in quantum mechanics?',
            options: [
                'Predicting classical behavior',
                'Calculating probabilities of quantum states',
                'Explaining relativistic effects',
                'Predicting behavior of quantum systems'
            ],
            correctAnswer: 'Predicting behavior of quantum systems'
        },
        {
            text: 'What famous thought experiment is associated with Schrödinger\'s cat?',
            options: [
                'Newton\'s Cradle',
                'Schrödinger\'s Box',
                'Schrödinger\'s Cat',
